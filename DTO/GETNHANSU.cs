...
namespace DXApplication1.DTO
{
    ...
    {
        public GETNHANSU(int id, string station, string hoten, string nangluc, string macode, string chuCvu, string nhiemvu, string ngay, string model, string cell, string status, string gio,string dotinhdien)
        {
            this.Hoten = hoten;
